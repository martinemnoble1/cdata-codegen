...
class CPhaseErrorPerformance(CPhaseErrorPerformanceStub):
    """
    QObject(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None
...
class CRefinementPerformance(CRefinementPerformanceStub):
    """
    QObject(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None
...
class CServalcatPerformance(CServalcatPerformanceStub):
    """
    QObject(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None
...
class CSuperposePerformance(CSuperposePerformanceStub):
    """
    QObject(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None
...
class CTestObsConversionsPerformance(CTestObsConversionsPerformanceStub):
    """
    QObject(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None
