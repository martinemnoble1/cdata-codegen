...
# Base classes
from core.base_object.base_classes import CContainer, CData

# Fundamental types
from core.base_object.fundamental_types import CBoolean, CList, CString
...
class CCustomTaskParamStub(CData):
    ...
    function: Optional[CCustomTaskFileFunctionStub] = None
    ...
    def __init__(self, parent=None, name=None, **kwargs):
        """
        Initialize CCustomTaskParamStub.
