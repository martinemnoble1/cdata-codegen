...
@cdata_class(
    ...
    gui_label="CCustomTaskParamList",
)
...
@cdata_class(
    attributes={
        ...
        "obligatory": attribute(AttributeType.CUSTOM, custom_class="core.CCP4Data.CBoolean", tooltip="obligatory attribute"),
        "saveDataToDb": attribute(AttributeType.CUSTOM, custom_class="core.CCP4Data.CBoolean", tooltip="saveDataToDb attribute"),
        "function": attribute(AttributeType.CUSTOM, custom_class="ccp4x.data_scan.CCP4CustomTaskManager.CCustomTaskFileFunction", tooltip="function attribute"),
        "mergeTo": attribute(AttributeType.CUSTOM, custom_class="core.CCP4Data.CString", tooltip="mergeTo attribute"),
        "splitColumns": attribute(AttributeType.CUSTOM, custom_class="core.CCP4Data.CString", tooltip="splitColumns attribute"),
        "requiredContentType": attribute(AttributeType.CUSTOM, custom_class="core.CCP4Data.CList", tooltip="requiredContentType attribute"),
        "outputFilePath": attribute(AttributeType.CUSTOM, custom_class="core.CCP4Data.CString", tooltip="outputFilePath attribute")
    },
    error_codes={
        "0": {
            "severity": 0,
...
@cdata_class(
    ...
    gui_label="CCustomTaskFileFunction",
)
...
@cdata_class(
    ...
    gui_label="CCustomTaskDefinition",
)
